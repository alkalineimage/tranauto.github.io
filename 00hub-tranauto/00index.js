...
const 	tranauto 			= document.getElementsByClassName("tranauto")[0];
const 	bg 			= document.getElementsByClassName("tranauto")[0];
...
const 	footer 		= document.getElementsByClassName("footer")[0];
		...
		body.innerHTML +=`	<div class="body">
							<div class="tagbox01">	<div class="tagbox0101">${tag.tag01}</div>
		...
		footer.innerHTML +=`	
							<div class="footer">
							<div class="footer01">	<a href="${indexsocials.toinstagram}">${icon.instagram}</a>
		...
		// 01 INDEX BACKGROUND
		bg.innerHTML +=`	<img src="${indeximg.index05image}"/> `;
