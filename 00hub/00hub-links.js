...
//--------------------------------------------------------------
const 	pagelinks 	= [{ 
		id:0,	toindexpage 	: page.indexpage ,
...
const 	indexlinkstosocials = [{ 
		id:0,	toinstagram 	: "#https://www.instagram.com/tranauto"	,
...
//		INDEX
const 	pageimages = [{ 
		id:0,	index01image 	: "00index01.jpg",
...
const 	indeximgs = [{ 
		id:0,	index01image : direct.topipe02 + pageimage.index01image,
...
const 	imagelinks = [{ 
		id:0,	index01image : direct.topipe002 + pageimage.index01image,
